...
const Home = () => {
  return (
    <>
      ...
      <section className="py-20 bg-neutral-50 dark:bg-neutral-800">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white dark:bg-neutral-900 rounded-lg p-6 shadow-soft hover:shadow-medium transition-shadow">
      ...
      {/* Example Section */}
      {import.meta.env.isActiveExampleSection && (
        <section className="py-20 bg-white dark:bg-neutral-900">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 dark:text-neutral-100 mb-4">
      ...
      <section className="py-20 bg-neutral-50 dark:bg-neutral-800">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="max-w-2xl mx-auto text-lg text-neutral-600 dark:text-neutral-400">
              Transform complex data structures with just a few clicks.
            </p>
          </div>
