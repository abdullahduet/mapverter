          ...
          {headers.map((_, colIndex) => {
            ...
            return (
              <td
                ...
                className={`whitespace-nowrap text-sm text-text-900 relative min-w-[120px] cursor-cell hover:bg-gray-100 ${isSelected ? 'bg-primary/10 bg-secondary/20 outline outline-secondary' : ''
  ...
  return (
    <div className="flex flex-col relative">
      ...
      >
        ...
        <table style={{ borderCollapse: 'separate', borderSpacing: '0', }} className="min-w-full table-fixed relative" // min-w-full divide-y divide-border table-fixed relative
        >
